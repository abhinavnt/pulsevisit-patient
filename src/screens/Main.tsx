  ...
  return (
    <ScreenWrapper className="bg-background pb-24">
      ...
      <div className="px-6 py-8">
        <h2 className="text-lg font-bold text-gray-900 mb-4">Book a Visit</h2>
        ...
        <Button variant="outline" className="gap-2 border-gray-200 text-gray-700 bg-white" onClick={() => {}}>
